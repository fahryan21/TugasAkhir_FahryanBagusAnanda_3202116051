...
<head>
    ...
    <title>Bouquet - The Evgift</title>
...
<body>
    ...
    <div class="background">
        <div class="container text-center text-light py-5">
            <h1 class="text-black">Bouquet Collection</h1>
            <p class="text-black">Explore our exquisite bouquet collection!</p>
        </div>
    </div>
        ...
        <div class="row mb-5">
            <?php if (isset($produk) && !empty($produk) && is_array($produk)) : ?>
                <?php foreach ($produk as $item) : ?>
                    <?php if ($item['id_kategori'] == 1) : // Pastikan id_kategori untuk bouquet adalah 1 ?>
